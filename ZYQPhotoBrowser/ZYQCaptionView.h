...
@interface ZYQCaptionView : UIView

@property (nonatomic, strong) UILabel *label;
@property (nonatomic, strong, readonly) id<ZYQPhoto> photo;

// Init
- (id)initWithPhoto:(id<ZYQPhoto>)photo;
...
// If you need more data per photo then simply subclass ZYQPhoto and return your
